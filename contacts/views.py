...
def contact(request):
    if request.method == "POST":
        ...
        send_mail(
            ...
            "rampantasain@gmail.com",
            ["rampantasain@gmail.com"], # Admin Email - Recipient
            fail_silently=False,
        )
        messages.success(request, "Your reqeuest submitted! A realtor will get back to you soon!")
        return redirect("/listings/"+listing_id)